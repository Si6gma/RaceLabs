...
import { Table, Download, Trash2, Calendar, Flag, Upload, Search, Filter, FileSpreadsheet, Eye } from 'lucide-react';
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              {!loading && filtered.length === 0 && (
                <tr>
                  <td colSpan={9} className="p-8 text-center text-sm text-motorsport-muted">
                    No sessions found. Import a CSV to get started.
                  </td>
                </tr>
              )}
              {filtered.map(s => (
